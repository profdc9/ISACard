...
#undef BITBANG_WRITE_SERIAL
#define BITBANG_WRITE_SERIAL_TX_PIN 9

#define ETHERNET_INPUT_INTERRUPT_PIN A5
#define ETHERNET_READ_INPUT_INTERRUPT_PIN() (PINC & 0x20)
#define ETHERNET_OUTPUT_INTERRUPT_PIN A4
#define ETHERNET_SET_OUTPUT_INTERRUPT_PIN() do {PORTC |= 0x10;} while (0)
#define ETHERNET_CLEAR_OUTPUT_INTERRUPT_PIN() do {PORTC &= ~0x10;} while (0)
#define ETHERNET_READ_OUTPUT_INTERRUPT_PIN() (PORTC & 0x10)
