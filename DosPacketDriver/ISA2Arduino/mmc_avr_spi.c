...
#ifdef BITBANG_WRITE_SERIAL
extern void write_dbg_string(const char *c);
extern void write_dbg_number(uint16_t n);
#else
#define write_dbg_string(x) {}
#define write_dbg_number(x) {}
#endif
...
#ifdef MMC_DEBUG
  write_dbg_string("wait ready ");
  write_dbg_number(d != 0xFF);
  write_dbg_string("\r\n");
#endif
...
#ifdef MMC_DEBUG
  write_dbg_string("rcvr_datablock ");
  write_dbg_number(token == 0xFE);
  write_dbg_string("\r\n");
#endif
...
#ifdef MMC_DEBUG
  write_dbg_string("xmit_datablock ");
  write_dbg_number(token == 0xFD);
  write_dbg_string("\r\n");
#endif
...
#ifdef MMC_DEBUG
  write_dbg_string("send_cmd ");
  write_dbg_number(cmd);
  write_dbg_string(" hi ");
  write_dbg_number(arg >> 16);
  write_dbg_string(" lo ");
  write_dbg_number(arg & 0xFFFF);
  write_dbg_string("\r\n");
#endif
...
#ifdef MMC_DEBUG
  write_dbg_string("res ");
  write_dbg_number(res);
  write_dbg_string("\r\n");
#endif
